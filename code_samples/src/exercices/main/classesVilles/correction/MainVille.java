...
import classesVilles.correction.Ville;
...
public class MainVille {
	public static void main(String[] args)
    {
        ...
        System.out.println( "paris.estDansLHemisphereNord() => " + paris.estDansLHemisphereNord() );
        System.out.println( "rioDeJaneiro.estDansLHemisphereNord() => " + rioDeJaneiro.estDansLHemisphereNord() );
